    ...
    <div className="fade-in">
      ...
      <div className="text-center mb-5">
        ...
        <p className="lead text-muted-modern">
          Complete guide to creating and managing your tournament preparation documents
        </p>
      </div>
          ...
          <div className="content-card-modern">
            <div className="d-flex align-items-start mb-3">
              ...
              <div className="flex-grow-1">
                ...
                >
                  <i className={`fas fa-${showExample ? 'eye-slash' : 'eye'} me-2`}></i>
                  {showExample ? "Hide Example" : "Show Example"}
                </button>

                {showExample && (
                  <div className="border rounded p-3 mb-3" style={{ background: "var(--bg-tertiary-light)" }}>
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      ...
                      <button
                        ...
                        onClick={() => navigator.clipboard.writeText(`Urshifu-Rapid-Strike @ Choice Scarf
Ability: Unseen Fist
Tera Type: Steel
...
- Fake Out`)}
                    ...
                    <pre className="calc-text mb-0" style={{ fontSize: "0.75rem", maxHeight: "300px", overflow: "auto" }}>
...
- Fake Out`}
                ...
                <div className="alert alert-info d-flex align-items-center" role="alert">
                  ...
                  <span>
                    <strong>Alternative:</strong> If you already have a saved document, 
                    use "Load Draft" to continue working on an existing document.
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="content-card-modern">
            <div className="d-flex align-items-start mb-3">
              ...
              <div className="flex-grow-1">
                ...
                <p className="mb-3">
                  Each Pokémon on your team can contain both offensive and defensive calculations. 
                  You can also add small notes, such as what your Pokémon outspeeds.
                </p>
          ...
          <div className="content-card-modern">
            <div className="d-flex align-items-start mb-3">
              ...
              <div className="flex-grow-1">
                ...
                <div className="mb-3">
                  <p className="mb-2">
                    Add matchups with titles and opponent paste links for easy access within the same document. 
                    You can add multiple matchups for different opponents or team archetypes.
                  </p>
                  
                  <div className="alert alert-success d-flex align-items-center mb-3" role="alert">
                    <i className="fas fa-star me-2"></i>
                    <span>
                      <strong>Pro Tip:</strong> Each matchup can contain multiple gameplans for different scenarios.
                    </span>
                  </div>
                </div>
                ...
                <div className="row g-3">
                  <div className="col-md-4">
                    <div className="text-center p-3 border rounded">
                      ...
                      <small className="text-muted-modern">Rich text editor for detailed strategies</small>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="text-center p-3 border rounded">
                      ...
                      <small className="text-muted-modern">Lead/Back role assignments for each Pokémon</small>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="text-center p-3 border rounded">
                      ...
                      <h6>Replay Links</h6>
                      <small className="text-muted-modern">Store links to practice games and battles</small>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="content-card-modern">
            <div className="d-flex align-items-start mb-3">
              ...
              <div className="flex-grow-1">
                ...
                <p className="mb-3">
                  While not the most user-friendly method, the best way to save your document locally 
                  and share it with others is to follow these steps:
                </p>
                ...
                <div className="row g-3">
                  <div className="col-md-4">
                    <div className="text-center p-3 border rounded h-100">
                      ...
                      <p className="small mb-0">
                        After saving your document locally, download the JSON file using "Download Draft"
                      </p>
                    </div>
                  </div>
                  <div className="col-md-4">
                  ...
                  <div className="col-md-4">
                    <div className="text-center p-3 border rounded h-100">
                      ...
                      <h6>Step 3</h6>
                      <p className="small mb-0">
                        They load the JSON file using "Load Draft" then "Save Locally" to access it
                      </p>
                    </div>
                  </div>
                </div>
